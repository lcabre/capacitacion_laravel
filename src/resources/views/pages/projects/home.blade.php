        ...
        <div class="text-center">
            ...
            @if(!empty($projects[0]->id))
                    <div name="project-cards" class="card">
                        ...
                        <a href="#" class="btn btn-link" role="button">{{ $project->name }}</a>  - Deadline: {{ $project->deadline }}
                        @endforeach
                    </div>
                    <br>
            ...
            @else
                <div name="no-projects">
                    <div class="card-header" >{{ __('There are no projects available at the moment :(') }}</div>
